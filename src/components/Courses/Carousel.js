...
const Carousel = () => {
  ...
  useEffect(()=>{
    ...
    return(
        ...
        <div data-aos="fade-up" className=" card flex flex-col px-4 py-3 bg-[#7A7B7F]/10 justify-between items-start desktop:h-[29rem] laptop:h-[29rem] h-[29rem] rounded-lg my-4">
